...
/**
 * Mirror of the right lamp without a postbox — just the Victorian gas
 * lamp + halo. Forms a pair with LampLetterbox so the bunting has two
 * anchor points.
 */
export function LeftLamp({ theme, parallax }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Lamppost SVG (same as right lamp) */}
      <svg
        viewBox="0 0 220 800"
        width="100%"
        height="100%"
      ...
      >
        <defs>
          <linearGradient id="ll-l-pole" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#1a1a1a" />
            <stop offset="48%" stopColor="#3a3530" />
            <stop offset="52%" stopColor="#3a3530" />
            <stop offset="100%" stopColor="#0a0a0a" />
          </linearGradient>
          <linearGradient id="ll-l-glass" x1="50%" y1="0%" x2="50%" y2="100%">
          ...
          <radialGradient id="ll-l-bulb" cx="50%" cy="40%" r="50%">
        ...
        <rect x="92" y="780" width="36" height="14" fill="url(#ll-l-pole)" />
        <rect x="86" y="772" width="48" height="10" fill="url(#ll-l-pole)" />
        <rect x="98" y="760" width="24" height="14" fill="url(#ll-l-pole)" />
        <rect x="106" y="180" width="8" height="582" fill="url(#ll-l-pole)" />
        <rect x="100" y="600" width="20" height="6" fill="url(#ll-l-pole)" />
        <rect x="100" y="400" width="20" height="6" fill="url(#ll-l-pole)" />
        <ellipse cx="110" cy="220" rx="11" ry="6" fill="url(#ll-l-pole)" />
        <ellipse cx="110" cy="208" rx="14" ry="5" fill="url(#ll-l-pole)" />
